...
![Waveform](./_sources_audio.md/start.webp)
...
![Add slience](./_sources_audio.md/silence.webp)

Our result will look like this:

![](./_sources_audio.md/after.webp)

Next, double-click or **Ctrl + A** on your keyboard and go to Tools --> Regular Interval Labels..., you can see this dialog:

![Regular Interval Labels Window](./_sources_audio.md/labels_window.webp){.side-img}
...
![After fill-in](./_sources_audio.md/labels_after.webp)

Click OK, and this is our result.

![Labels](./_sources_audio.md/result.webp)
...
![Approach 1](./_sources_audio.md/appr1.webp)
...
![Length and End of Selection](./_sources_audio.md/length.webp){.side-img}

![Approach 2](./_sources_audio.md/appr2.webp)
...
![Approach 2 finshed](./_sources_audio.md/appr2_after.webp)
